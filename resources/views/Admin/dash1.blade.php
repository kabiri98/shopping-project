...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
            ...
            <div class="sidebar" style="direction: ltr">
                <div style="direction: rtl">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <ca href="#" class="d-block">کبیری</ca>
                        </div>
                    </div>
                 ...
                 with font-awesome or any other icon font library -->
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{'dash1'}}" class="nav-link active">
                                            <i class="fa fa-circle-o nav-icon"></i>
                                            <p>داشبورد اول</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{'dash2'}}" class="nav-link">
                                            <i class="fa fa-circle-o nav-icon"></i>
                                            <p>داشبورد دوم</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{'dash3'}}" class="nav-link">
                                            <i class="fa fa-circle-o nav-icon"></i>
                                            <p>داشبورد سوم</p>
                                        </a>
                                    </li>
            ...
            <section class="content">
                <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-header d-flex p-0">
                                    <h3 class="card-title p-3">
                                        <i class="fa fa-pie-chart mr-1"></i> فروش
                                    </h3>
                    ...
                    <i class="fa fa-minus"></i>
                                        ...
                                        <button type="button" class="btn btn-tool" data-toggle="tooltip" title="مخاصبین" data-widget="chat-pane-toggle">
                    <i class="fa fa-comments"></i>
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name float-left">کبیری</span>
                      ...
                      <button type="button" class="btn btn-primary">Send</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <i class="ion ion-clipboard mr-1"></i> لیست کارها
                                    </h3>
                        ...
                        <section class="col-lg-5 connectedSortable">
                            ...
                            <div class="card bg-primary-gradient">
                                <div class="card-header no-border">
                                    <h3 class="card-title">
                                        <i class="fa fa-map-marker mr-1"></i> بازدید‌ها
                                    </h3>
                                    <!-- card tools -->
                                    <div class="card-tools">
                    ...
                    <i class="fa fa-minus"></i>
                            ...
                            <div class="card bg-info-gradient">
                                <div class="card-header no-border">
                                    <h3 class="card-title">
                                        <i class="fa fa-th mr-1"></i> نمودار فروش
                                    </h3>
                    ...
                    <i class="fa fa-times"></i>
                            ...
                            <div class="card bg-success-gradient">
                                <div class="card-header no-border">
                                    ...
                                    <h3 class="card-title">
                                        <i class="fa fa-calendar"></i> تقویم
                                    </h3>
                                    <!-- tools card -->
                                    <div class="card-tools">
        ...
        <footer class="main-footer">
            <strong>CopyLeft &copy; 2018 <a href="http://github.com/hesammousavi/">کبیری</a>.</strong>
        </footer>
