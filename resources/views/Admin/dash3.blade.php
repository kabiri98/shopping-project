                 ...
                 with font-awesome or any other icon font library -->
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{'dash3'}}" class="nav-link active">
                                            <i class="fa fa-circle-o nav-icon"></i>
                                            <p>داشبورد سوم</p>
                                        </a>
                                    </li>
                ...
                <div class="container-fluid">
                    ...
                    <i class="fa fa-square text-gray"></i> هفته گذشته
                                ...
                                <div class="card-body p-0">
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2"> تلویزیون هوشمند
                                                </td>
                                                <td>13 تومان</td>
                                                <td>
                        ...
                        12%
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2"> محصول ایکس
                                                </td>
                                                <td>29 تومان</td>
                                                <td>
                        ...
                        0.5%
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2"> محصول پرفروش
                                                </td>
                                                <td>1,230 تومان</td>
                                                <td>
                        ...
                        3%
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2"> محصول جدید
